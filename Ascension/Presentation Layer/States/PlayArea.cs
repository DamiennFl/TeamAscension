...
namespace Ascension
{
    public class PlayArea
    {
        ...
        {
            // Top part of rectangle
            spriteBatch.Draw(this.borderTexture, new Rectangle(this.BorderRectangle.X - 40, this.BorderRectangle.Y - 40, this.BorderRectangle.Width + 90, this.BorderWidth + 40), Color.Transparent);

            // Bottom part of rectangle
            spriteBatch.Draw(this.borderTexture, new Rectangle(this.BorderRectangle.X - 30, this.BorderRectangle.Y + this.BorderRectangle.Height - this.BorderWidth, this.BorderRectangle.Width + 30, this.BorderWidth + 40), Color.Transparent);

            // Left part of rectangle
            spriteBatch.Draw(this.borderTexture, new Rectangle(this.BorderRectangle.X - 60, this.BorderRectangle.Y - 30, this.BorderWidth + 60, this.BorderRectangle.Height + 60), Color.Transparent);

            // Right part of rectagnle
            spriteBatch.Draw(this.borderTexture, new Rectangle(this.BorderRectangle.X + this.BorderRectangle.Width - this.BorderWidth, this.BorderRectangle.Y - 30, this.BorderWidth + 90, this.BorderRectangle.Height + 30), Color.Transparent);
        }
    }
}
